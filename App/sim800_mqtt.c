        ...
        if (hSIM800.State >= SIM800_TCP_CONNECTED)
        {
            ...
            if (rx_chars[0] != -1)
            {
                ...
                if ((rx_chars[0] & 0x30) == 0x30)
                {
                    ...
                    if (topic_len > sizeof(hSIM800.PUBREC.Topic))
                    {
                        topic_len = sizeof(hSIM800.PUBREC.Topic);
 ...
 */
__weak void APP_SIM800_MQTT_CONNACK_CB(uint8_t code)
{
}
